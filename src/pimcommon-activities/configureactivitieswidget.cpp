...
ActivitiesBaseManager::ActivitySettings ConfigureActivitiesWidget::activitiesSettings() const
{
    ...
    const ActivitiesBaseManager::ActivitySettings activities{selectedActivities, true};
    return activities;
}

void ConfigureActivitiesWidget::setActivitiesSettings(const ActivitiesBaseManager::ActivitySettings &activitySettings)
{
