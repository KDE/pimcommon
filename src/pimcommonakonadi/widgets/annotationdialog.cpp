    ...
    , d(new AnnotationEditDialogPrivate)
{
    ...
    auto label = new QLabel(i18nc("@label:textbox", "Enter the text that should be stored as a note to the mail:"), this);
...
{
    KConfigGroup group(KSharedConfig::openStateConfig(), QLatin1StringView(myConfigAnnotationEditDialog));
